...
# This exception should be raised in some specific case,
# for example if you try to open a project
# and your script didn't find any created projects you could raise an exception for this case.
# After it you should add a rescue end code block
# (which will catch your specific Exception class)
...
module OurExceptions

  class NoProjectError < StandardError
    def initialize
      puts 'Oops! Such project does not exist'
    end
  end
